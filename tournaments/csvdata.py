...
def get_tournament_name(tournament):
    if tournament in [
        WC_2015_MO_GAMES_FOX,
        WC_2015_WO_GAMES_FOX,
        WC_2015_MXO_GAMES_FOX,
        WC_2015_SMX_GAMES_FOX,
        WC_2015_W27_GAMES_FOX,
        WC_2015_M30_GAMES_FOX,
    ]:
    ...
    def __init__(self, row, game, tournament_name, division):
        if row is None:
            ...
            super(CsvGame, self).__init__(
                ...
                row[TG_TIME_INDEX],
                row[TG_FIELD_INDEX],
                row[TG_LOCAL_TEAM_INDEX],
                row[TG_LOCAL_TEAM_SCORE_INDEX],
                row[TG_VISITOR_TEAM_SCORE_INDEX],
                row[TG_VISITOR_TEAM_INDEX],
            )
...
class FoxGame(CsvGame):
    ...
    def get_game_statistic_file_to_save(self):
        destination = (
            ...
            + self.local
            + "-"
            + str(self.local_score)
            + "-"
            + str(self.visitor_score)
            + "-"
            + self.visitor
            + ".html"
        )
...
remote_files_EUROS_2014_MO = [
    "https://www.internationaltouch.org/events/euros/2014/mens-open/"
]
remote_files_EUROS_2014_WO = [
    "https://www.internationaltouch.org/events/euros/2014/womens-open/"
]
remote_files_EUROS_2014_MXO = [
    "https://www.internationaltouch.org/events/euros/2014/mixed-open/"
]
remote_files_EUROS_2014_SMX = [
    "https://www.internationaltouch.org/events/euros/2014/senior-mixed/"
]
...
remote_files_EUROS_2016_WO = [
    "https://www.internationaltouch.org/events/euros/2016/womens-open/"
]
remote_files_EUROS_2016_MXO = [
    "https://www.internationaltouch.org/events/euros/2016/mixed-open/"
]
remote_files_EUROS_2016_SMX = [
    "https://www.internationaltouch.org/events/euros/2016/senior-mixed/"
]
remote_files_EUROS_2016_W27 = [
    "https://www.internationaltouch.org/events/euros/2016/womens-27/"
]


local_files_WC_2015_MO_FX = [
    RAW_GAMES_FILES + "WC2015_MO_FOX_POOLA.html",
...
local_files_WC_2015_M30_FX = [
    RAW_GAMES_FILES + "WC2015_M30_FOX_POOLA.html",
    RAW_GAMES_FILES + "WC2015_M30_FOX_CHAMPIONSHIP.html",
]

local_files_WC_2015_WO_FX = [
    RAW_GAMES_FILES + "WC2015_WO_FOX_POOLA.html",
...
local_files_WC_2015_W27_FX = [
    RAW_GAMES_FILES + "WC2015_W27_FOX_POOLA.html",
    RAW_GAMES_FILES + "WC2015_W27_FOX_CHAMPIONSHIP.html",
]

local_files_WC_2015_MXO_FX = [
    RAW_GAMES_FILES + "WC2015_MXO_FOX_POOLA.html",
...
local_files_WC_2015_SMX_FX = [
    RAW_GAMES_FILES + "WC2015_SMX_FOX_POOLA.html",
    RAW_GAMES_FILES + "WC2015_SMX_FOX_PLAYOFF.html",
    RAW_GAMES_FILES + "WC2015_SMX_FOX_CHAMPIONSHIP.html",
]

local_files_NTL_2016_M_FX = [
    RAW_GAMES_FILES + "NTL2016_MO_FOX_POOLA.html",
    RAW_GAMES_FILES + "NTL2016_MO_FOX_FINALS.html",
]

local_files_NTL_2016_WO_FX = [
    RAW_GAMES_FILES + "NTL2016_WO_FOX_POOLA.html",
...
(
    ...
    NTL_2016_MO_GAMES_FOX,
    NTL_2016_WO_GAMES_FOX,
    WC_2015_MO_GAMES_FIT,
    WC_2015_WO_GAMES_FIT,
    WC_2015_MXO_GAMES_FIT,
    EUROS_2014_MO,
    EUROS_2014_WO,
    EUROS_2014_MXO,
    EUROS_2014_W27,
